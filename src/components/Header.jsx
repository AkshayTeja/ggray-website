      ...
      <div className="bg-gray-900 text-gray-300 py-2 px-4 text-sm">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-2">
          <div className="flex items-center gap-4 flex-wrap">
            <a href={`mailto:${companyInfo.email}`} className="flex items-center gap-2 hover:text-orange-500 transition-colors">
              <Mail size={14} />
              <span className="hidden sm:inline">{companyInfo.email}</span>
            </a>
            <a href={`tel:${companyInfo.phone}`} className="flex items-center gap-2 hover:text-orange-500 transition-colors">
              <Phone size={14} />
          ...
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center gap-3">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm text-gray-600 hidden sm:block">Racking System</span>
              </div>
            </Link>
            ...
            <nav className="hidden lg:flex items-center gap-8">
              {navLinks.map((link) => (
                ...
                >
                  {link.name}
                  <span className={`absolute bottom-0 left-0 w-0 h-0.5 bg-orange-600 transition-all group-hover:w-full ${
            ...
            <div className="hidden lg:block">
              <Button 
                ...
                className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-2 transition-all hover:shadow-lg"
              >
