        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              >
                We're here to help you optimize your warehouse space. Reach out
                to us for product inquiries, custom solutions, or to schedule a
                free consultation. Our team of experts is ready to assist you.
              </motion.p>
              ...
              >
                ...
                <Button
                  ...
                  className="bg-green-600 hover:bg-green-700 text-white w-full rounded-sm"
                  size="lg"
                >
                  Chat on WhatsApp
                </Button>
              ...
              <Card>
                <CardContent className="p-8">
                  ...
                  >
                    ...
                    >
                      Your message will be sent via WhatsApp for instant
                      response
                    </motion.p>
                  </motion.form>
                </CardContent>
      ...
      <section className="py-20 bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            >
              <Button
                className="bg-orange-600 hover:bg-orange-700 text-white inline-flex items-center gap-2 group transition-all hover:shadow-2xl font-semibold rounded-sm"
                size="lg"
              >
                <MapPin size={18} />
